...
</div># <div align="center">👨‍💻 Julian Camilo Villamizar Montañez</div>
...
```java
public class Julian {
    private String[] currentFocus = {"Desarrollo web con JavaScript", "Java Backend", "Cloud Technologies"};
    private String[] currentLearning = {"React", "Node.js", "AWS"};
    ...
    public String[] getInterests() {
        return new String[]{"Desarrollo de software", "Arquitectura de sistemas", "DevOps"};
    }
...
- Java SE Programmer (En progreso)
- JavaScript Developer (En progreso)
